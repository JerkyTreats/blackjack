...
class Gameplay(object):
    ...
    def Hit(self):
        ...
        players_total = (first_card_value + second_card_value)

        print "You have: ", players_total
        print "\nHIT OR STAY?\n"
        ...
        if next == 'hit':
            ...
            players_total = (players_total + hit_card_value)
            print "You have ", players_total
            return players_total
        elif next == 'stay':
            return players_total
        else next != 'hit' or 'stay':
            print "Incorrect command, please enter 'hit' or 'stay' without quote
